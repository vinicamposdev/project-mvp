...
void AssignmentMip() {
  ...
  // };
  const std::vector<std::vector<double>> costs = {
    {{-20, 1000000000, -10, 1000000000, 10}},
    {{-30, 1000000000, -20,         10, 10}},
    {{-20, 1000000000, -10,         10, 10}},
    {{-10,        -10,  10, 1000000000, 20}},
    {{  0,          0,  20, 1000000000, 20}},
  };

  // criar arcos com for duplo
  // sroa rick
  // yeiniel

  // testar isso com entrada simples 2x2, 3x3, 4x4

  const int num_flow = costs.size();
